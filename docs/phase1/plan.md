...
画像をもとにした LLM 分析は、セル値、OOXML メタデータ、block 検出結果を補うための補足情報として扱う。
...
- 画像 attachment の分析結果は、構造抽出結果を補完する補足情報として扱う。
...
4. 画像を attachment として LLM に渡し、補足情報として本文へ反映できる。
